                            ...
                            <c-slot name="menu">
                                ...
                                <c-modal id="View-Child-{{ $key }}" size="md" :initOpen="false">
                                    ...
                                    <c-modal.viewcard>
                                        ...
                                        <c-modal.viewitem icon="{{ asset('assets/icons/location-05.svg') }}"
                                            title="GS Division" info="{{ ucfirst($child['gs_division']) }}" />
                                        <c-modal.viewitem icon="{{ asset('assets/icons/location-05.svg') }}"
                                            title="Address" info="N0 21,Yoak Road,Moratuwa" />
                                    </c-modal.viewcard>
                                ...
                                <c-modal id="edit-child-profile-{{ $key }}" size="md"
                                    ...
                                    <form id="edit-child-profile-form-{{ $child['id'] }}" class="child-form"
                                        ...
                                        <c-textarea label="Additional Notes:" name="e_text"
                                            placeholder="Enter any additional notes here..." rows="4"></c-textarea>
                                    </form>
                                    <c-slot name="close">
                                        Close
                                    </c-slot>
